...
`brew install ag amethyst awscli bat cmake ctags htop git-sizer gping k9s jq minikube mysql nmap node nvm onefetch parquet-tools pre-commit psql pstree postgresql pyenv pyenv-virtualenv telnet tmux`
